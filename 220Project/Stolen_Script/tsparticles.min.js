...
!function(t, i) {
    ...
    4: function(t, i, e) {
        ...
        class w {}
        w.canvasClass = "tsparticles-canvas-el",
        w.randomColorValue = "random",
        w.midColorValue = "mid",
        w.touchEndEvent = "touchend",
        w.mouseUpEvent = "mouseup",
        w.mouseMoveEvent = "mousemove",
        w.touchStartEvent = "touchstart",
        w.touchMoveEvent = "touchmove",
        w.mouseLeaveEvent = "mouseleave",
        w.touchCancelEvent = "touchcancel",
        w.resizeEvent = "resize",
        w.visibilityChangeEvent = "visibilitychange",
        w.noPolygonDataLoaded = "No polygon data loaded.",
        w.noPolygonFound = "No polygon found, you need to specify SVG url in config.";
        class x {
            static colorToRgb(t)
            {
                var i,
                ...
                if ("string" == typeof s.value)
                    o = s.value === w.randomColorValue ? this.getRandomRgbColor() : x.stringToRgb(s.value);
            ...
            static hslToRgb(t)
            {
                ...
                if (0 === e.s)
                    ...
                    const t = e.l < .5 ? e.l * (1 + e.s) : e.l + e.s - e.l * e.s,
                        s = 2 * e.l - t;
                    i.r = x.hue2rgb(s, t, e.h + 1 / 3),
                    i.g = x.hue2rgb(s, t, e.h),
                    i.b = x.hue2rgb(s, t, e.h - 1 / 3)
                }
        ...
        class z {
            ...
            {
                if (i && t)
                    return t instanceof Array ? t.find(t => z.isInArray(i, t.ids)) : z.isInArray(i, t.ids) ? t : void 0
            }
        }
        !function(t) {
            t.char = "char",
        ...
        class P {
            ...
            init(t)
            {
                ...
                return s(this, void 0, void 0, (function* () {
                    ...
                    if (!z.isInArray(n.image, e.type) && !z.isInArray(n.images, e.type))
                        return;
                    const s = null !== (i = e.options[n.images]) && void 0 !== i ? i : e.options[n.image];
                    if (s instanceof Array)
                        for (const i of s)
                            yield this.loadImageShape(t, i);
                    else
                        yield this.loadImageShape(t, s)
                }))
            }
            destroy()
            {
            ...
            draw(t, i, e, s)
            {
                ...
                (null == a ? void 0 : a.data.svgData) && (null == a ? void 0 : a.replaceColor) || (t.globalAlpha = s),
                t.drawImage(r, c.x, c.y, 2 * e, 2 * e / l),
                (null == a ? void 0 : a.data.svgData) && (null == a ? void 0 : a.replaceColor) || (t.globalAlpha = 1)
            }
        }
        class M {
            static getPlugin(t)
        ...
        class E {
            ...
            static drawLinkLine(t, i, e, s, o, n, a, r, l, c, h)
            {
                ...
                if (z.getDistance(e, s) <= o)
                    ...
                    const r = {
                        ...
                        {dx: l, dy: c, distance: h} = z.getDistances(e, r);
                    if (h <= o) {
                        const t = e.y - c / l * e.x;
                        i = {
                            x: 0,
                        ...
                        const t = {
                            ...
                            {dx: r, dy: l, distance: c} = z.getDistances(e, t);
                        if (c <= o) {
            ...
            {
                this.drawTriangle(t, e, s, o),
                t.lineWidth = i,
                n && (t.globalCompositeOperation = "destination-out"),
                t.fillStyle = x.getStyleFromRgb(a, r),
                t.fill()
            }
            ...
            static drawGrabLine(t, i, e, s, o, n)
            {
                t.save(),
                this.drawLine(t, e, s),
                t.strokeStyle = x.getStyleFromRgb(o, n),
                t.lineWidth = i,
                t.stroke(),
                t.restore()
            }
            static drawParticle(t, i, e, s, o, n, a, r, l)
            {
                ...
                i.translate(c.x, c.y),
                i.beginPath(),
                0 !== e.angle && i.rotate(e.angle * Math.PI / 180),
                n && (i.globalCompositeOperation = "destination-out");
                const h = e.shadowColor;
                l.enable && h && (i.shadowBlur = l.blur, i.shadowColor = x.getStyleFromRgb(h), i.shadowOffsetX = l.offset.x, i.shadowOffsetY = l.offset.y),
                i.fillStyle = o;
                const d = e.stroke;
                i.lineWidth = d.width,
                e.strokeColor && (i.strokeStyle = x.getStyleFromRgb(e.strokeColor, e.stroke.opacity)),
                e.close && i.closePath(),
                this.drawShape(t, i, e, a, r, s),
                d.width > 0 && e.strokeColor && i.stroke(),
                e.fill && i.fill(),
                i.restore(),
                i.save(),
                i.translate(c.x, c.y),
                0 !== e.angle && i.rotate(e.angle * Math.PI / 180),
                n && (i.globalCompositeOperation = "destination-out"),
                this.drawShapeAfterEffect(t, i, e, a, r, s),
                i.restore()
            }
        ...
        class I {
            ...
            init()
            {
                ...
                this.coverColor = x.colorToRgb(i),
                this.trailFillColor = x.colorToRgb(e.fillColor),
                this.paint()
            }
            loadCanvas(t, i)
            {
                var e;
                t.className || (t.className = w.canvasClass),
                this.generatedCanvas && (null === (e = this.element) || void 0 === e || e.remove()),
                this.generatedCanvas = null != i && i,
                this.element = t,
            ...
            destroy()
            {
                ...
                this.context && E.clear(this.context, this.size)
            }
            resize()
            {
            ...
            drawLinkTriangle(t, i, e)
            {
                ...
                if (!m) {
                    ...
                    if (e === w.randomColorValue)
                        m = x.getRandomRgbColor();
                    else if ("mid" === e) {
                        const i = t.getColor(),
                            e = r.getColor();
                        if (i && e)
                            m = x.mix(i, e, t.size.value, r.size.value);
                        else {
                            const t = null != i ? i : e;
                            if (!t)
                                return;
            ...
            drawLinkLine(t, i)
            {
                ...
                if (!h) {
                    ...
                    if (e === w.randomColorValue)
                        h = x.getRandomRgbColor();
                    else if ("mid" === e) {
                        const i = t.getColor(),
                            e = n.getColor();
                        if (i && e)
                            h = x.mix(i, e, t.size.value, n.size.value);
                        else {
                            const t = null != i ? i : e;
                            if (!t)
                                return;
            ...
            lineStyle(t, i)
            {
                ...
                if (this.context)
                    return E.gradient(this.context, t, i, e.links.opacity)
            }
            initBackground()
            {
                ...
                t.image && (e.backgroundImage = t.image),
                t.position && (e.backgroundPosition = t.position),
                t.repeat && (e.backgroundRepeat = t.repeat),
                t.size && (e.backgroundSize = t.size)
            }
        }
        !function(t) {
            t.bubble = "bubble",
        ...
        class D {
            ...
            moveParticle(t)
            {
                ...
                this.applyNoise(t),
                e.position.x += e.velocity.horizontal * l,
                e.position.y += e.velocity.vertical * l,
                s.move.vibrate && (e.position.x += Math.sin(e.position.x * Math.cos(e.position.y)), e.position.y += Math.cos(e.position.y * Math.sin(e.position.x)))
            }
            applyNoise(t)
            {
                const i = this.particle;
                if (!i.particlesOptions.move.noise.enable)
                    return;
                const e = this.container;
                if (i.lastNoiseTime <= i.noiseDelay)
                    return void (i.lastNoiseTime += t);
                const s = e.noise.generate(i);
                i.velocity.horizontal += Math.cos(s.angle) * s.length,
                i.velocity.horizontal = z.clamp(i.velocity.horizontal, -1, 1),
                i.velocity.vertical += Math.sin(s.angle) * s.length,
                i.velocity.vertical = z.clamp(i.velocity.vertical, -1, 1),
                i.lastNoiseTime -= i.noiseDelay
            }
            moveParallax()
            {
                ...
                e.offset.x += (l - e.offset.x) / r,
                e.offset.y += (c - e.offset.y) / r
            }
            getProximitySpeedFactor()
            {
                const t = this.container,
                    i = t.options;
                if (!z.isInArray(a.slow, i.interactivity.events.onHover.mode))
                    return 1;
        ...
        class L {
            ...
            updateAngle(t)
            {
                const i = this.container.options,
                    e = this.particle,
                    s = i.fpsLimit > 0 ? 60 * t / 1e3 : 3.6;
                if (e.particlesOptions.rotate.animation.enable)
                    switch (e.rotateDirection) {
                    case h.clockwise:
                        e.angle += e.particlesOptions.rotate.animation.speed * Math.PI / 18 * s,
                        e.angle > 360 && (e.angle -= 360);
                        break;
                    case h.counterClockwise:
                    default:
                        e.angle -= e.particlesOptions.rotate.animation.speed * Math.PI / 18 * s,
                        e.angle < 0 && (e.angle += 360)
                    }
            }
            updateColor(t)
            {
            ...
            fixOutOfCanvasPosition()
            {
                ...
                if (n = e === d.bounce ? {
                    ...
                    e.left > o.width - i.offset.x ? (i.position.x = n.left, s || (i.position.y = Math.random() * o.height)) : e.right < -i.offset.x && (i.position.x = n.right, s || (i.position.y = Math.random() * o.height)),
                    e.top > o.height - i.offset.y ? (s || (i.position.x = Math.random() * o.width), i.position.y = n.top) : e.bottom < -i.offset.y && (s || (i.position.x = Math.random() * o.width), i.position.y = n.bottom)
                }
            }
            updateOutMode(t)
            {
            ...
            updateBounce(t)
            {
                ...
                for (const [, o] of i.plugins)
                    if (void 0 !== o.particleBounce && (s = o.particleBounce(e, t)), s)
                        break;
                if (!s) {
        ...
        class Q {
            ...
            set image(t)
            {
                this.options[n.image] = t,
                this.options[n.images] = t
            }
            get custom()
            {
                return this.options
            ...
            set character(t)
            {
                this.options[n.character] = t,
                this.options[n.char] = t
            }
            get polygon()
            {
                var t;
            ...
            set polygon(t)
            {
                this.options[n.polygon] = t,
                this.options[n.star] = t
            }
            load(t)
            {
                var i,
                ...
                this.loadShape(t.character, n.character, n.char, !0),
                this.loadShape(t.polygon, n.polygon, n.star, !1),
                this.loadShape(null !== (s = t.image) && void 0 !== s ? s : t.images, n.image, n.images, !0),
        ...
        class dt {
            constructor(t, i, e)
            {
                ...
                void 0 !== e && O.load(e),
                void 0 !== (null === (f = this.shapeData) || void 0 === f ? void 0 : f.particles) && O.load(null === (g = this.shapeData) || void 0 === g ? void 0 : g.particles),
                this.particlesOptions = O;
                const T = this.particlesOptions.move.noise.delay;
                this.noiseDelay = 1e3 * (T.random.enable ? z.randomInRange(T.random.minimumValue, T.value) : T.value),
                ...
                if (this.particlesOptions.size.animation.enable) {
                    ...
                    this.size.status = l.increasing,
                    this.size.velocity = (null !== (w = this.sizeAnimationSpeed) && void 0 !== w ? w : t.retina.sizeAnimationSpeed) / 100,
                    this.particlesOptions.size.animation.sync || (this.size.velocity = this.size.velocity * Math.random())
                }
                this.particlesOptions.color.animation.enable ? (this.colorVelocity = this.particlesOptions.color.animation.speed / 100, this.particlesOptions.color.animation.sync || (this.colorVelocity = this.colorVelocity * Math.random())) : this.colorVelocity = 0,
                ...
                this.particlesOptions.collisions.enable && this.checkOverlap(i),
                this.color = x.colorToHsl(R);
                ...
                this.particlesOptions.opacity.animation.enable && (this.opacity.status = r.increasing, this.opacity.velocity = this.particlesOptions.opacity.animation.speed / 100, this.particlesOptions.opacity.animation.sync || (this.opacity.velocity *= Math.random())),
                ...
                if (H || (H = M.getShapeDrawer(this.shape), H && t.drawers.set(this.shape, H)), this.shape === n.image || this.shape === n.images) {
                    ...
                    if (void 0 !== (null == o ? void 0 : o.svgData) && n.replaceColor && a) {
                        ...
                        r.addEventListener("load", () => {
                            this.image && (this.image.loaded = !0, o.element = r),
                            e.revokeObjectURL(s)
                        }),
                        r.addEventListener("error", () => {
                            e.revokeObjectURL(s),
                            z.loadImage(n.src).then(t => {
                    ...
                    this.fill = null !== (S = n.fill) && void 0 !== S ? S : this.fill,
                    this.close = null !== (A = n.close) && void 0 !== A ? A : this.close
                }
                ...
                this.strokeColor = x.colorToRgb(this.stroke.color),
                this.shadowColor = x.colorToRgb(this.particlesOptions.shadow.color),
                this.updater = new L(this.container, this)
            }
            update(t)
            {
                this.links = [],
        ...
        class pt {
            ...
            subdivide()
            {
                const t = this.rectangle.position.x,
                    ...
                    o = this.capacity;
                this.northEast = new pt(new vt(t, i, e / 2, s / 2), o),
                this.northWest = new pt(new vt(t + e / 2, i, e / 2, s / 2), o),
                this.southEast = new pt(new vt(t, i + s / 2, e / 2, s / 2), o),
                this.southWest = new pt(new vt(t + e / 2, i + s / 2, e / 2, s / 2), o),
                this.divided = !0
            }
            insert(t)
            {
            ...
            query(t, i)
            {
                ...
                if (!t.intersects(this.rectangle))
                    return [];
                for (const i of this.points.filter(i => t.contains(i.position)))
                    a.push(i.particle);
        ...
        class ft {
            ...
            isEnabled()
            {
                ...
                if (!e.onHover.enable || !i.position)
                    return !1;
                    ...
                    for (const n of a) {
                        ...
                        if (r <= e.retina.grabModeDistance) {
                            ...
                            if (c > 0) {
                                ...
                                let r;
                                if (e.particles.grabLineColor || (e.particles.grabLineColor = s === w.randomColorValue || (null === (i = s) || void 0 === i ? void 0 : i.value) === w.randomColorValue ? w.randomColorValue : x.colorToRgb(s)), r = e.particles.grabLineColor === w.randomColorValue ? x.getRandomRgbColor() : e.particles.grabLineColor, void 0 === r)
                                    return;
        ...
        class gt {
            ...
            isEnabled()
            {
                ...
                if (!(n || s.onHover.enable && e.position || s.onClick.enable && e.clickPosition))
                    return !1;
            ...
            processRepulse(t, i, e, s)
            {
                ...
                for (const e of a) {
                    const {dx: a, dy: r, distance: l} = z.getDistances(e.position, t),
                        c = {
                            x: a / l,
                            y: r / l
                        },
                        h = 100 * (null !== (o = null == s ? void 0 : s.speed) && void 0 !== o ? o : n.options.interactivity.modes.repulse.speed),
                        u = z.clamp((1 - Math.pow(l / i, 2)) * h, 0, 50),
                        v = e.particlesOptions.move.outMode,
                        p = e.size.value,
                        m = {
                    ...
                    if (v === d.bounce || v === d.bounceVertical || v === d.bounceHorizontal) {
                        ...
                        (v === d.bounceVertical || t.horizontal) && (e.position.x = m.x),
                        (v === d.bounceHorizontal || t.vertical) && (e.position.y = m.y)
                    } else
                        e.position.x = m.x,
                        e.position.y = m.y
                }
            ...
            clickRepulse()
            {
                ...
                if (t.repulse.finish || (t.repulse.count || (t.repulse.count = 0), t.repulse.count++, t.repulse.count === t.particles.count && (t.repulse.finish = !0)), t.repulse.clicking) {
                    ...
                    for (const i of n) {
                        const {dx: o, dy: n, distance: a} = z.getDistances(s, i.position),
                            r = a * a,
                            l = t.options.interactivity.modes.repulse.speed,
                            c = -e * l / r;
                    ...
                    for (const i of t.repulse.particles)
                        i.velocity.horizontal = i.initialVelocity.horizontal,
                        i.velocity.vertical = i.initialVelocity.vertical;
                    t.repulse.particles = []
                }
            }
            processClickRepulse(t, i, e, s)
            {
                const o = this.container,
                    n = o.options,
                    a = Math.atan2(e, i);
                t.velocity.horizontal = s * Math.cos(a),
                t.velocity.vertical = s * Math.sin(a);
                ...
                if (r === d.bounce || r === d.bounceHorizontal || r === d.bounceVertical) {
                    ...
                    r !== d.bounceVertical && (i.x + t.size.value > o.canvas.size.width || i.x - t.size.value < 0) && (t.velocity.horizontal *= -1),
                    r !== d.bounceHorizontal && (i.y + t.size.value > o.canvas.size.height || i.y - t.size.value < 0) && (t.velocity.vertical *= -1)
                }
            }
        }
        !function(t) {
        ...
        class bt {
            ...
            singleDivHover(t, i)
            {
                ...
                for (const i of l.filter(t => r.contains(t.getPosition()))) {
                    ...
                    const s = e.options.interactivity.modes.bubble.divs,
                        o = z.divMode(s, t);
                    i.bubble.divId && i.bubble.divId === t || (this.reset(i, !0), i.bubble.divId = t),
                    this.hoverBubbleSize(i, 1, o),
                    this.hoverBubbleOpacity(i, 1, o),
                    this.hoverBubbleColor(i, o)
                }
            }
            process(t, i, e, s)
            {
                ...
                if (n !== l)
                    if (o.bubble.durationEnd)
                        c && (d === f.size && delete t.bubble.radius, d === f.opacity && delete t.bubble.opacity);
                    else if (i <= r) {
                        if ((null != c ? c : h) !== n) {
                            const i = h - e * (h - n) / a;
                            d === f.size && (t.bubble.radius = i),
                            d === f.opacity && (t.bubble.opacity = i)
                        }
                    } else
                        d === f.size && delete t.bubble.radius,
                        d === f.opacity && delete t.bubble.opacity
            }
            clickBubble()
            {
                var t;
                ...
                for (const o of n) {
                    ...
                    if (i.bubble.clicking) {
                        r > e.interactivity.modes.bubble.duration && (i.bubble.durationEnd = !0),
                        r > 2 * e.interactivity.modes.bubble.duration && (i.bubble.clicking = !1, i.bubble.durationEnd = !1);
                        const s = {
                            bubbleObj: {
                        ...
                        this.process(o, a, r, n),
                        i.bubble.durationEnd ? delete o.bubble.color : a <= i.retina.bubbleModeDistance ? this.hoverBubbleColor(o) : delete o.bubble.color
                    }
                }
            }
            hoverBubble()
            {
                ...
                for (const e of s) {
                    ...
                    o <= t.retina.bubbleModeDistance ? n >= 0 && t.interactivity.status === w.mouseMoveEvent && (this.hoverBubbleSize(e, n), this.hoverBubbleOpacity(e, n), this.hoverBubbleColor(e)) : this.reset(e),
                    t.interactivity.status === w.mouseLeaveEvent && this.reset(e)
                }
            }
        ...
        class kt {
            ...
            interact(t)
            {
                ...
                for (const i of a) {
                    if (t === i || i.particlesOptions.move.attract.enable)
                        continue;
                    const e = i.getPosition(),
                        {dx: o, dy: a} = z.getDistances(n, e),
                        r = s.particles.move.attract.rotate,
                        l = o / (1e3 * r.x),
                        c = a / (1e3 * r.y);
                    t.velocity.horizontal -= l,
                    t.velocity.vertical -= c,
                    i.velocity.horizontal += l,
                    i.velocity.vertical += c
                }
            }
            isEnabled(t)
            {
        ...
        class Pt {
            ...
            static bounce(t, i)
            {
                ...
                if (o * (s.x - e.x) + n * (s.y - e.y) >= 0) {
                    ...
                    i.velocity.horizontal = u.horizontal,
                    i.velocity.vertical = u.vertical
                }
            }
            static destroy(t, i)
            {
            ...
            absorb(t, i)
            {
                ...
                if (void 0 === t.size.value && void 0 !== i.size.value)
                    t.destroy();
                    ...
                    if (t.size.value >= i.size.value) {
                        ...
                        t.size.value += o,
                        i.size.value -= o,
                        i.size.value <= e.retina.pixelRatio && (i.size.value = 0, i.destroy())
                    } else {
                        const o = z.clamp(i.size.value / t.size.value, 0, t.size.value) * s;
                        t.size.value -= o,
                        i.size.value += o,
                        t.size.value <= e.retina.pixelRatio && (t.size.value = 0, t.destroy())
                    }
            }
        }
        class Mt {
            ...
            interact(t, i)
            {
                var e,
                    s;
                if (t.updateInfection(i), void 0 === t.infectionStage)
                    return;
                const o = this.container,
                    n = o.options.infection;
                if (!n.enable || n.stages.length < 1)
                    return;
                ...
                for (const i of d)
                    if (Math.random() < u / v)
                        if (void 0 === i.infectionStage)
                            i.startInfection(h);
                        else if (i.infectionStage < t.infectionStage)
                            i.updateInfectionStage(h);
                        else if (i.infectionStage > t.infectionStage) {
        ...
        class St {
            ...
            {
                this.container = t,
                this.externalInteractors = [new bt(t), new wt(t), new ft(t), new gt(t)],
                this.particleInteractors = [new kt(t), new Pt(t), new Mt(t), new zt(t)]
            }
            init() {}
            interact(t)
            {
        ...
        class At {
            constructor(t)
            {
                this.container = t,
                this.array = [],
                this.interactionManager = new St(t);
                const i = this.container.canvas.size;
                this.linksColors = {},
                this.quadTree = new pt(new vt(0, 0, i.width, i.height), 4)
            }
            get count()
            {
            ...
            init()
            {
                ...
                for (const [, i] of t.plugins)
                    if (void 0 !== i.particlesInitialization && (e = i.particlesInitialization()), e)
                        break;
                if (!e)
            ...
            {
                if (t >= 0 && t <= this.count)
                    for (const e of this.array.splice(t, null != i ? i : 1))
                        e.destroy()
            }
            remove(t)
            {
            ...
            update(t)
            {
                ...
                for (const s of this.array) {
                    ...
                    s.destroyed || s.update(t),
                    s.destroyed ? e.push(s) : this.quadTree.insert(new mt(s.getPosition(), s))
                }
                for (const t of e)
                    this.remove(t);
            ...
            draw(t)
            {
                ...
                this.quadTree = new pt(new vt(0, 0, e.width, e.height), 4),
                this.update(t);
                for (const [, e] of i.plugins)
                    i.canvas.drawPlugin(e, t);
            ...
            push(t, i)
            {
                ...
                for (let i = 0; i < t; i++)
                    this.addParticle(a);
                o.particles.move.enable || this.container.play(),
                this.pushing = !1
            }
            addParticle(t, i)
            {
            ...
            removeQuantity(t)
            {
                const i = this.container.options;
                this.removeAt(0, t),
                i.particles.move.enable || this.container.play()
            }
        }
        class Ct {
            constructor(t)
            ...
            init()
            {
                ...
                const s = i.particles;
                this.linksDistance = s.links.distance * e,
                this.linksWidth = s.links.width * e,
                this.moveSpeed = s.move.speed * e,
                this.sizeValue = s.size.value * e,
                this.sizeAnimationSpeed = s.size.animation.speed * e;
                const o = i.interactivity.modes;
                this.connectModeDistance = o.connect.distance * e,
                this.connectModeRadius = o.connect.radius * e,
                this.grabModeDistance = o.grab.distance * e,
                this.repulseModeDistance = o.repulse.distance * e,
                this.slowModeRadius = o.slow.radius * e,
                this.bubbleModeDistance = o.bubble.distance * e,
                o.bubble.size && (this.bubbleModeSize = o.bubble.size * e)
            }
            initParticle(t)
            {
                const i = t.particlesOptions,
                    e = this.pixelRatio;
                t.linksDistance = i.links.distance * e,
                t.linksWidth = i.links.width * e,
                t.moveSpeed = i.move.speed * e,
                t.sizeValue = i.size.value * e,
                "boolean" != typeof i.size.random && (t.randomMinimumSize = i.size.random.minimumValue * e),
                t.sizeAnimationSpeed = i.size.animation.speed * e
            }
        }
        class Ot {
            constructor(t)
            ...
            nextFrame(t)
            {
                ...
                if (void 0 !== i.lastFrameTime && t < i.lastFrameTime + 1e3 / s)
                    return void i.draw();
                const o = t - i.lastFrameTime;
                i.lastFrameTime = t,
                i.particles.draw(o),
                e.particles.move.enable && i.getAnimationStatus() && i.draw()
            }
        }
        !function(t) {
            t.canvas = "canvas",
        ...
        class Dt {
            ...
            load(t)
            {
                ...
                void 0 !== o && (o instanceof Array ? this.onDiv = o.map(t => {
                    const i = new Rt;
                    return i.load(t), i
                }) : (this.onDiv = new Rt, this.onDiv.load(o))),
        ...
        class Xt {
            ...
            load(t)
            {
                ...
                !0 === (null === (s = null === (e = t.modes) || void 0 === e ? void 0 : e.slow) || void 0 === s ? void 0 : s.active) && (this.events.onHover.mode instanceof Array ? this.events.onHover.mode.indexOf(a.slow) < 0 && this.events.onHover.mode.push(a.slow) : this.events.onHover.mode !== a.slow && (this.events.onHover.mode = [this.events.onHover.mode, a.slow]))
            }
        }
        class Yt {
            constructor()
        ...
        class ii {
            constructor()
            {
                this.background = new Zt,
                this.backgroundMask = new Qt,
                this.detectRetina = !0,
                this.fpsLimit = 30,
                this.infection = new ti,
                this.interactivity = new Xt,
                this.particles = new ht,
                this.pauseOnBlur = !0
            }
            get fps_limit()
            {
        ...
        class ei {
            ...
            manageListeners(t)
            {
                ...
                o && (e.interactivity.events.onHover.enable || e.interactivity.events.onClick.enable) && (ei.manageListener(o, w.mouseMoveEvent, this.mouseMoveHandler, t), ei.manageListener(o, w.touchStartEvent, this.touchStartHandler, t), ei.manageListener(o, w.touchMoveEvent, this.touchMoveHandler, t), e.interactivity.events.onClick.enable || ei.manageListener(o, w.touchEndEvent, this.touchEndHandler, t), ei.manageListener(o, w.mouseLeaveEvent, this.mouseLeaveHandler, t), ei.manageListener(o, w.touchCancelEvent, this.touchCancelHandler, t)),
                e.interactivity.events.onClick.enable && o && (ei.manageListener(o, w.touchEndEvent, this.touchEndClickHandler, t), ei.manageListener(o, w.mouseUpEvent, this.mouseUpHandler, t)),
                e.interactivity.events.resize && ei.manageListener(window, w.resizeEvent, this.resizeHandler, t),
                document && ei.manageListener(document, w.visibilityChangeEvent, this.visibilityChangeHandler, t, !1)
            }
            handleWindowResize()
            {
                const t = this.container,
                ...
                e.width = t.canvas.size.width,
                e.height = t.canvas.size.height,
                i.particles.move.enable || t.particles.redraw(),
            ...
            mouseTouchMove(t)
            {
                ...
                if (t.type.startsWith("mouse")) {
                    this.canPush = !0;
                    const e = t;
                    if (void 0 === (null === (i = o.interactivity) || void 0 === i ? void 0 : i.element))
                        return;
                ...
                a && (a.x *= l, a.y *= l),
                o.interactivity.mouse.position = a,
                o.interactivity.status = w.mouseMoveEvent
            }
            mouseTouchFinish()
            {
                const t = this.container;
                delete t.interactivity.mouse.position,
                t.interactivity.status = w.mouseLeaveEvent
            }
            mouseTouchClick(t)
            {
                const i = this.container,
                ...
                if (void 0 !== o && e.interactivity.events.onClick.enable) {
                    for (const [, t] of i.plugins)
                        if (void 0 !== t.clickPositionValid && (s = t.clickPositionValid(o), s))
                            break;
            ...
            doMouseTouchClick(t)
            {
                ...
                if (this.canPush) {
                    ...
                    if (s.mode instanceof Array)
                        for (const t of s.mode)
                            this.handleClickMode(t);
                    else
                        this.handleClickMode(s.mode)
                }
        ...
        class si {
            ...
            {
                this.id = t,
                this.sourceOptions = i,
                this.started = !1,
                this.destroyed = !1,
                this.paused = !0,
                this.lastFrameTime = 0,
                this.pageHidden = !1,
                this.retina = new Ct(this),
                this.canvas = new I(this),
                this.particles = new At(this),
                ...
                this.options = new ii;
                for (const t of e)
                    this.options.load(M.getPreset(t));
                ...
                this.eventListeners = new ei(this)
            }
            play(t)
            {
            ...
            initDensityFactor()
            {
                ...
                if (!this.canvas.element || !t.enable)
                    return;
        ...
        class ai {
            constructor(t, i, e, s)
            {
                ...
                r && (a = z.randomInRange(l, a)),
                this.opacity = this.options.opacity,
                this.size = a * i.retina.pixelRatio,
                this.mass = this.size * e.size.density;
            ...
            attract(t)
            {
                const i = t.getPosition(),
                    {dx: e, dy: s, distance: o} = z.getDistances(this.position, i),
                    n = Math.atan2(e, s) * (180 / Math.PI),
                    a = this.mass / Math.pow(o, 2);
                if (o < this.size + t.size.value) {
                    const i = .033 * t.size.value;
                    this.size > t.size.value && o < this.size - t.size.value ? t.destroy() : (t.size.value -= i, t.velocity.horizontal += Math.sin(n * (Math.PI / 180)) * a, t.velocity.vertical += Math.cos(n * (Math.PI / 180)) * a),
                    (void 0 === this.limit || this.size < this.limit) && (this.size += i),
                    this.mass += i * this.options.size.density
                } else
                    t.velocity.horizontal += Math.sin(n * (Math.PI / 180)) * a,
                    t.velocity.vertical += Math.cos(n * (Math.PI / 180)) * a
            }
            resize()
            {
            ...
            draw(t)
            {
                ...
                t.closePath(),
                t.fillStyle = x.getStyleFromRgb(this.color, this.opacity),
                t.fill()
            }
            calcPosition()
            {
        ...
        const ui = new class {
            ...
            loadOptions(t, i)
            {
                var e,
                    s;
                if (!this.needsPlugin(t) && !this.needsPlugin(i))
                    return;
                const o = t;
                (null == i ? void 0 : i.absorbers) && ((null == i ? void 0 : i.absorbers) instanceof Array ? o.absorbers = null == i ? void 0 : i.absorbers.map(t => {
                    const i = new ci;
                    return i.load(t), i
                }) : ((o.absorbers instanceof Array || void 0 === o.absorbers) && (o.absorbers = new ci), o.absorbers.load(null == i ? void 0 : i.absorbers)));
        ...
        class yi {
            constructor(t, i, e, s)
            {
                ...
                this.container = i,
                this.initialPosition = s,
                this.emitterOptions = z.deepExtend({}, e),
                this.position = null !== (o = this.initialPosition) && void 0 !== o ? o : this.calcPosition();
                let r = z.deepExtend({}, this.emitterOptions.particles);
                void 0 === r && (r = {}),
                void 0 === r.move && (r.move = {}),
                void 0 === r.move.direction && (r.move.direction = this.emitterOptions.direction),
                this.particlesOptions = r,
                this.size = null !== (n = this.emitterOptions.size) && void 0 !== n ? n : (() => {
                    const t = new mi;
                    return t.load({
                        height: 0,
                        mode: vi.percent,
                ...
                this.lifeCount = null !== (a = this.emitterOptions.life.count) && void 0 !== a ? a : -1,
                this.play()
            }
            play()
            {
            ...
            prepareToDie()
            {
                ...
                this.lifeCount > 0 && void 0 !== (null === (t = this.emitterOptions.life) || void 0 === t ? void 0 : t.duration) && window.setTimeout(() => {
                    ...
                    this.pause(),
                    this.lifeCount--,
                    this.lifeCount > 0 ? (this.position = this.calcPosition(), window.setTimeout(() => {
                        this.play()
            ...
            emit()
            {
                ...
                for (let o = 0; o < this.emitterOptions.rate.quantity; o++)
        ...
        const xi = new class {
            ...
            loadOptions(t, i)
            {
                ...
                if (!this.needsPlugin(t) && !this.needsPlugin(i))
                    return;
                const o = t;
                (null == i ? void 0 : i.emitters) && ((null == i ? void 0 : i.emitters) instanceof Array ? o.emitters = null == i ? void 0 : i.emitters.map(t => {
                    const i = new bi;
                    return i.load(t), i
                }) : ((o.emitters instanceof Array || void 0 === o.emitters) && (o.emitters = new bi), o.emitters.load(null == i ? void 0 : i.emitters)));
        ...
        class Ti {
            ...
            load(t)
            {
                ...
                if (void 0 !== t) {
                    ...
                    void 0 !== t.type && (this.type = t.type),
                    void 0 !== t.enable ? this.enable = t.enable : this.enable = this.type !== zi.none,
                    void 0 !== t.url && (this.url = t.url),
                    void 0 !== t.data && ("string" == typeof t.data ? this.data = t.data : (this.data = new Oi, this.data.load(t.data))),
        ...
        class Ri {
            ...
            static drawPolygonMask(t, i, e)
            {
                ...
                if (s) {
                    ...
                    for (const e of i)
                        t.lineTo(e.x, e.y);
                    t.closePath(),
                    t.strokeStyle = x.getStyleFromRgb(s),
                    t.lineWidth = e.width,
                    t.stroke()
                }
            }
            ...
            initAsync(t)
            {
                return s(this, void 0, void 0, (function* () {
                    ...
                    this.polygonMaskMoveRadius = i.move.radius * this.container.retina.pixelRatio,
                    i.enable && (yield this.initRawData())
                }))
            }
            resize()
            {
            ...
            particlePosition(t, i)
            {
                ...
                if (!(o.enable && (null !== (s = null === (e = this.raw) || void 0 === e ? void 0 : e.length) && void 0 !== s ? s : 0) > 0))
                    return;
            ...
            particleBounce(t)
            {
                ...
                if (i.enable && i.type !== zi.none && i.type !== zi.inline) {
                    if (!this.checkInsidePolygon(t.getPosition()))
                        return Ri.polygonBounce(t), !0
                } else if (i.enable && i.type === zi.inline && t.initialPosition) {
                    if (z.getDistance(t.initialPosition, t.getPosition()) > this.polygonMaskMoveRadius)
                        return Ri.polygonBounce(t), !0
                }
                return !1
            }
            ...
            checkInsidePolygon(t)
            {
                ...
                const s = this.container,
                    o = this.options;
                if (!o.enable || o.type === zi.none || o.type === zi.inline)
                    return !0;
                if (!this.raw)
                    throw new Error(w.noPolygonFound);
            ...
            parseSvgPath(t, i)
            {
                ...
                const d = a.retina.pixelRatio,
                    u = r.scale / d;
                this.dimension.width = parseFloat(null !== (e = c.getAttribute("width")) && void 0 !== e ? e : "0") * u,
                this.dimension.height = parseFloat(null !== (s = c.getAttribute("height")) && void 0 !== s ? s : "0") * u;
            ...
            getRandomPoint()
            {
                if (!this.raw || !this.raw.length)
                    throw new Error(w.noPolygonDataLoaded);
            ...
            getEquidistantPointByIndex(t)
            {
                ...
                const l = this.container.options,
                    c = this.options;
                if (!this.raw || !this.raw.length || !(null === (i = this.paths) || void 0 === i ? void 0 : i.length))
                    throw new Error(w.noPolygonDataLoaded);
                let h,
                    d = 0;
            ...
            initRawData(t)
            {
                return s(this, void 0, void 0, (function* () {
                    const i = this.options;
                    if (i.url)
                        this.raw = yield this.downloadSvgPath(i.url, t);
                    else if (i.data) {
                        const e = i.data;
                        let s;
                        if ("string" != typeof e) {
        ...
        const Ei = new class {
            ...
            loadOptions(t, i)
            {
                if (!this.needsPlugin(i))
                    return;
                const e = t;
                void 0 === e.polygon && (e.polygon = new Ti),
                e.polygon.load(null == i ? void 0 : i.polygon)
            }
        }
        ;
        const Ii = new class  extends class {
            constructor()
            {
                ...
                const t = new b,
                    i = new k,
                    e = new P;
                M.addShapeDrawer(n.line, new S),
                M.addShapeDrawer(n.circle, new A),
                M.addShapeDrawer(n.edge, t),
                M.addShapeDrawer(n.square, t),
                M.addShapeDrawer(n.triangle, new O),
                M.addShapeDrawer(n.star, new T),
                M.addShapeDrawer(n.polygon, new R),
                M.addShapeDrawer(n.char, i),
                M.addShapeDrawer(n.character, i),
                M.addShapeDrawer(n.image, e),
                M.addShapeDrawer(n.images, e)
            }
            init()
            {
        ...
        ;
        Ii.init();
        const {particlesJS: Di, pJSDom: Li} = (t => {
