    ...
    return (n = {}, s.m = i = [function(e, t, i) {
        ...
        var s = function() {
            ...
            r = function() {
                for (var e, t = "transform webkitTransform mozTransform oTransform msTransform".split(" "), i = 0; void 0 === e;)
                    e = void 0 !== document.createElement("div").style[t[i]] ? t[i] : void 0,
                    i++;
                return e
            }(),
            a = function(e) {
        ...
        var u = function() {
            ...
            return function(e, t, i) {
                ...
                key: "setStyle",
                value: function() {
                    !1 === this.settings.overflow && (this.element.style[r] = "scale(" + this.settings.scale + ")"),
                ...
                value: function() {
                    var e,
                        t = 0,
                        i = 0;
                    (this.settings.orientation.includes("left") || this.settings.orientation.includes("right")) && (i = (this.settings.orientation.includes("left") ? -1 * this.translateValue : this.translateValue) + "px"),
                    (this.settings.orientation.includes("up") || this.settings.orientation.includes("down")) && (t = (this.settings.orientation.includes("up") ? -1 * this.translateValue : this.translateValue) + "px"),
                    e = !1 === this.settings.overflow ? "translate3d(" + i + ", " + t + ", 0) scale(" + this.settings.scale + ")" : "translate3d(" + i + ", " + t + ", 0)",
        ...
        var f,
            ...
            y = function() {
                function i(e, t) {
                    ...
                    e && (this.elements = o(e), this.defaults = {
                        delay: .4,
                        orientation: "up",
                        scale: 1.3,
                        overflow: !1,
                ...
                return function(e, t, i) {
                    ...
                    value: function() {
                        ...
                        f = v.length,
                        g || (this.proceedRequestAnimationFrame(), window.addEventListener("resize", this.handleResize), g = !0)
                    }
                }, {
                    key: "handleResize",
                    value: function() {
